...
import srilankaTea from "@/assets/sri-lanka/srilanka-tea.jpg";
import srilankaBeach from "@/assets/sri-lanka/srilanka-beach.jpg";
import srilankaColombo from "@/assets/sri-lanka/srilanka-colombo.png";
import sigiriyaRock from "@/assets/sri-lanka/sig-rock.jpg";

// 2x (retina) gallery images — Sri Lanka (4 tiles)
import tile1_800_srilanka from "@/assets/sri-lanka/sri-lanka-tile.jpg";
import tile2_800_srilanka from "@/assets/sri-lanka/tile2_800_srilanka.webp";
import tile3_800_srilanka from "@/assets/sri-lanka/tile3_800_srilanka.webp";
import tile4_800_srilanka from "@/assets/sri-lanka/tile4_800_srilanka.webp";

import mirissaBeach from "@/assets/sri-lanka/srilanka-mirissa-beach.jpg";
import hillCountryTrain from "@/assets/sri-lanka/srilanka-hill-country-train.jpg";

// Review images
import review1 from "@/assets/sri-lanka/srilanka-hero.jpg";
import review2 from "@/assets/sri-lanka/srilanka-beach.jpg";

import srilankaDay01 from "@/assets/sri-lanka/srilanka-day01.jpg";
import srilankaDay02 from "@/assets/sri-lanka/srilanka-day02-temple.webp";
import srilankaDay04 from "@/assets/sri-lanka/srilanka-day04-main-temple-of-tooth.jpg";
import srilankaDay05 from "@/assets/sri-lanka/srilanka-day05-main-kandy-2.jpg";
import srilankaDay06 from "@/assets/sri-lanka/srilanka-day05-ella-bridge.jpg";
import srilankaDay07 from "@/assets/sri-lanka/srilanka-day07-little-adams-peak.jpg";

import srilankaDay08 from "@/assets/sri-lanka/srilanka-mirissa-beach.jpg";
import srilankaDay09 from "@/assets/sri-lanka/sri-lanka-surf.jpg";
import srilankaDay10 from "@/assets/sri-lanka/srilanka-day10-main-mirissa-beach.jpg";
import srilankaDay11 from "@/assets/sri-lanka/srilanka-day11-main-goodbye-group-photo.jpg"; // only if you actually have Day 11

import videotrain from "@/assets/sri-lanka/sri-lanka-train.mp4";
import videorock from "@/assets/sri-lanka/sri-lanka-rock.mp4";
import videomirissa from "@/assets/sri-lanka/mirissa-sri-lanka.mp4";

import covertrain from "@/assets/sri-lanka/cover-sri-lanka-train.jpg";
import coverrock from "@/assets/sri-lanka/lions-rock-2.jpg";
import covermirissa from "@/assets/sri-lanka/cover-mirissa.jpg";
...
export const srilankaData = {
  ...
  slug: "sri-lanka",
  title: "Anamta & Taimoor Best of Sri Lanka",
  aboutTitle: "Anamta & Taimoor Sri Lanka",
  tags: [
  ...
  hideTagsOnDesktop: true,
  subtitle:
    "Discover the Pearl of the Indian Ocean with its ancient heritage and stunning landscapes",
  location: "Sri Lanka",
  duration: "11 days",
  heroImage: srilankaDay06,
  price: "USD $1,449",
  priceNote: "First 6 bookings, then USD $1,549",
  startDate: "May 8th",
  overviewGallery2x: [
    tile1_800_srilanka,
    hillCountryTrain,
  ...
  route: ["Colombo", "Sigiriya", "Kandy", "Ella", "Mirissa"],
  aboutDescription: [
  ...
  whatsIncludedHighlights: [
    {
      ...
      description:
        "From heritage hotels to tea plantation bungalows and beach resorts across the island!"
    },
    {
      icon: Zap,
      title: "11 DAYS OF<br />DISCOVERY",
      description:
        "Ancient rock fortresses, tea country railways, wildlife safaris & pristine beaches!",
      link: {
    ...
    },
    {
      ...
      description:
        "Meet & greet at Colombo airport plus private vehicle with driver throughout your journey."
    },
    {
      icon: Users,
      title: "EXPERT LOCAL<br />GUIDES",
      description:
        "Knowledgeable Sri Lankan guides who share the island's rich history and cultural insights."
    },
    {
      icon: Soup,
      title: "AUTHENTIC<br />CUISINE",
      description:
        "2 Dinners, 10 Breakfasts featuring rice & curry, tea tastings & local specialties!"
    },
    {
      icon: TreePine,
      title: "100% CARBON<br />NEUTRAL",
      description:
        "Your Sri Lankan adventure supports local conservation and sustainable wildlife protection."
    }
  ],
  ...
  highlights: [
    {
      ...
      description:
        "Ride the famous tea-country railway through misty mountains and emerald plantations.",
      image: covertrain,
      video: videotrain
    },
    {
      title: "Lion's Rock",
      description: "Climb Sri Lanka’s iconic Lion's Rock.",
      image: coverrock,
      video: videorock
    },
    {
  ...
  included: [
    ...
    },
    {
      ...
      items: [
        {
          text:
            "Airport pick-up from Bandaranaike International Airport (Day 1)"
        },
        {
          text:
            "Private transport between all cities and regions (Colombo ➜ Sigiriya ➜ Ella ➜ Mirissa)"
        },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "2.5 hours, can take taxi or Uber (transfer not included). Departure from Colombo Bandaranaike International Airport (CMB)"
    },
    {
    ...
    },
    {
      ...
      answer:
        "Apply for E-VISA. Electronic Travel Authorization (ETA): Most visitors can obtain a tourist ETA online through the Sri Lankan government's ETA website: https://www.eta.gov.lk/slvisa/visainfo/center.jsp?locale=en_US"
    }
  ],
  review: {
    testimonialText:
